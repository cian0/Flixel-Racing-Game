...
package 
{
	...
	{
		//Embedded media...
		[Embed(source="assets/mapCSV_racingTrackGroup_road64x48_1.csv", mimeType="application/octet-stream")] public var CSV_racingTrackGrouproad64x48_1:Class;
		[Embed(source="assets/64x48_2.png")] public var Img_racingTrackGrouproad64x48_1:Class;
		...
		//Tilemaps
		public var layerracingTrackGrouproad64x48_1:FlxTilemap;
		...
		{
			// Generate maps.
			layerracingTrackGrouproad64x48_1 = new FlxTilemap;
			layerracingTrackGrouproad64x48_1.loadMap( new CSV_racingTrackGrouproad64x48_1, Img_racingTrackGrouproad64x48_1, 64,48, FlxTilemap.OFF, 0, 1, 1 );
			layerracingTrackGrouproad64x48_1.x = 0.000000;
			layerracingTrackGrouproad64x48_1.y = 0.000000;
			layerracingTrackGrouproad64x48_1.scrollFactor.x = 1.000000;
			layerracingTrackGrouproad64x48_1.scrollFactor.y = 1.000000;
			...
			layerracingTrackGrouproad128x48.loadMap( new CSV_racingTrackGrouproad128x48, Img_racingTrackGrouproad128x48, 64,96, FlxTilemap.OFF, 0, 1, 1 );
			...
			layerracingTrackGroup2road64x96_2.loadMap( new CSV_racingTrackGroup2road64x96_2, Img_racingTrackGroup2road64x96_2, 64,96, FlxTilemap.OFF, 0, 1, 1 );
			...
			layerracingTrackGroup3road64x96_1.loadMap( new CSV_racingTrackGroup3road64x96_1, Img_racingTrackGroup3road64x96_1, 64,96, FlxTilemap.OFF, 0, 1, 1 );
			...
			masterLayer.add(layerracingTrackGrouproad64x48_1);
			...
			mainLayer = layerracingTrackGrouproad64x48_1;
